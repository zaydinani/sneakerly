            ...
            $repeater->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .woolentor-horizontal-filter-wrap .woolentor-filter-single-item{{CURRENT_ITEM}} .select2-container' => 'min-width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
                    ...
                    <div class="woolentor-filter-header-top-area">
                        ...
                        <div class="woolentor-header-right-side">
                            ...
                            <?php if( $settings['show_filter_reset_btton'] == 'yes' ): ?>
                                <div class="woolentor-search-filter-custom">
                                    <a href="#" id="filter-reset-<?php echo esc_attr($id); ?>" class="filter-icon filter-reset" alt="<?php echo esc_attr__('Reset Filter','woolentor');?>"><?php echo $filter_reset_btton_icon; ?></a>
                                </div>
                            <?php endif; ?>
                                    ...
                                    if( isset( $filter_list ) ){
                                        foreach ( $filter_list as $filter_key => $filter_item ) {
                                            ...
                                            if( 'yes' === $settings['show_filter_label'] ){
                                                $filter_label = '<label for="woolentor-field-for-'.esc_attr($filter_item['_id']).'">'.$filter_item['wl_filter_title'].'</label>';
                                            }
                                            ...
                                            ?>
                                                <div class="woolentor-filter-single-item woolentor-states-input-auto elementor-repeater-item-<?php echo esc_attr($filter_item['_id']); ?>">
                                                    ...
                                                    <select data-filter-key="wlsort" name="wl_sort" id="woolentor-field-for-<?php echo esc_attr($filter_item['_id']); ?>" class="woolentor-onchange-single-item woolentor-single-select-<?php echo esc_attr($id); ?>" data-minimum-results-for-search="Infinity" data-placeholder="<?php echo $filter_item['wl_filter_placeholder']; ?>">
                                                        <?php
                                                            if( !empty( $filter_item['wl_filter_placeholder'] ) ){echo '<option></option>';}
                                                        ?>
                                                        <option value="<?php echo esc_attr('ASC');?>" <?php selected( 'ASC', $wlsort, true ); ?> ><?php echo esc_html__( $sort_by_asc_lavel, 'woolentor' ); ?></option>
                                                        <option value="<?php echo esc_attr('DESC');?>" <?php selected( 'DESC', $wlsort, true ); ?> ><?php echo esc_html__( $sort_by_desc_lavel, 'woolentor' ); ?></option>
                                                    </select>
                                                </div>
                                            <?php
                                                ...
                                                <div class="woolentor-filter-single-item woolentor-states-input-auto elementor-repeater-item-<?php echo esc_attr($filter_item['_id']); ?>">
                                                    <?php echo $filter_label; ?>
                                                    <select data-filter-key="wlorder_by" name="wl_order_by_sort" id="woolentor-field-for-<?php echo esc_attr($filter_item['_id']); ?>" class="woolentor-onchange-single-item woolentor-single-select-<?php echo esc_attr($id); ?>" data-minimum-results-for-search="Infinity" data-placeholder="<?php echo esc_attr($filter_item['wl_filter_placeholder']); ?>">
                                                        <?php
                                                            if( !empty( $filter_item['wl_filter_placeholder'] ) ){echo '<option></option>';}
                                                ...
                                                <div class="woolentor-filter-single-item woolentor-states-input-auto elementor-repeater-item-<?php echo esc_attr($filter_item['_id']); ?>">
                                                    <?php echo $filter_label; ?>
                                                    <select data-filter-key="wlstock" name="wl_sttock" id="woolentor-field-for-<?php echo esc_attr($filter_item['_id']); ?>" class="woolentor-onchange-single-item woolentor-single-select-<?php echo esc_attr($id); ?>" data-minimum-results-for-search="Infinity" data-placeholder="<?php echo esc_attr($filter_item['wl_filter_placeholder']); ?>">
                                                        <?php
                                                            if( !empty( $filter_item['wl_filter_placeholder'] ) ){echo '<option></option>';}
                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ( $price_range_list as $key => $price_range ) {
                                                                    ...
                                                                    if( $currency_pos_left ){
                                                                        $generate_price = sprintf('%s%s %s %s%s',$final_currency_symbol,$min_price, $price_seprator,$final_currency_symbol,$max_price );
                                                                    }else{
                                                                        $generate_price = sprintf('%s%s %s %s%s',$min_price, $final_currency_symbol, $price_seprator,$max_price, $final_currency_symbol );
                                                                    }

                                                                    echo sprintf("<option value='%s' data-min_price='%s' data-max_price='%s' %s>%s</option>", $key, $min_price, $max_price, selected( $pselected, 1, false ), $generate_price );
                                                                }
                                                ...
                                                if ( !empty( $terms ) && !is_wp_error( $terms )){
                                                    ...
                                                    echo $filter_label;
                                                    echo '<select data-filter-key="'.esc_attr($filter_name).'" name="wltaxonomies['.$filter_item['wl_filter_type'].'][]" class="woolentor-onchange-multiple-item woolentor-multiple-select-'.esc_attr($id).'" '.$sl_placeholder.' multiple="multiple">';
