...
<div class="pp-settings-section">
	<div class="pp-settings-section-header">
		<h3 class="pp-settings-section-title"><?php esc_html_e( 'White Label', 'powerpack' ); ?></h3>
	</div>
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						<textarea id="pp_plugin_desc" name="pp_plugin_desc" style="width: 25em;"><?php echo wp_kses_post( $settings['plugin_desc'] ); ?></textarea>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">
					...
					<td>
						<input id="pp_plugin_author" name="pp_plugin_author" type="text" class="regular-text" value="<?php echo esc_attr( $settings['plugin_author'] ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">
				...
				<tr valign="top">
					...
					<td>
						<input id="pp_admin_label" name="pp_admin_label" type="text" class="regular-text" value="<?php echo esc_attr( $settings['admin_label'] ); ?>" placeholder="PowerPack" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">
					...
					<td>
						<input id="pp_support_link" name="pp_support_link" type="text" class="regular-text" value="<?php echo esc_url( $settings['support_link'] ); ?>" placeholder="https://powerpackelements.com/contact/" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">
