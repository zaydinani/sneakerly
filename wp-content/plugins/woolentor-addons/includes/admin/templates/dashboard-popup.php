...
<div id="woolentor-admin-pro-popup" class="woolentor-admin-popup">
    <div class="woolentor-admin-popup-inner">
        ...
        <div class="woolentor-admin-popup-icon"><img src="<?php echo esc_url( WOOLENTOR_ADDONS_PL_URL.'includes/admin/assets/images/icons/pro-badge.png' ); ?>" alt="<?php echo esc_attr__('pro','woolentor');?>"></div>
